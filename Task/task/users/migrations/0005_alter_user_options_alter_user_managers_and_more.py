# Generated by Django 5.1.3 on 2024-11-06 11:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='role',
            field=models.CharField(choices=[('IN', 'Intern'), ('FR', 'Frontend'), ('BK', 'Backend'), ('DO', 'Devops'), ('PM', 'Project_Manager'), ('AN', 'Analyst'), ('DS', 'Designer')], default='IN', max_length=2, null=True),
        ),
    ]
